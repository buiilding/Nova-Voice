"""
health_monitor.py - Health monitoring and metrics for the Gateway service
...
class HealthMonitor:
    ...
    async def start_health_server(self):
        ...
        app.router.add_post('/auth/google', self.auth_google_handler)
        app.router.add_post('/auth/github', self.auth_github_handler)
        app.router.add_post('/auth/microsoft', self.auth_microsoft_handler)
        app.router.add_post('/auth/discord', self.auth_discord_handler)
        app.router.add_get('/auth/callback', self.auth_callback_handler)
        app.router.add_get('/auth/status', self.auth_status_handler)
        app.router.add_post('/auth/logout', self.auth_logout_handler)
        app.router.add_post('/auth/validate', self.auth_validate_handler)
